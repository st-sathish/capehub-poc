...
import static com.capestartproject.common.job.api.Job.FailureReason.NONE;
...
@XmlType(name = "job", namespace = "http://com.capestart.job")
@XmlRootElement(name = "job", namespace = "http://com.capestart.job")
