...
import com.capestartproject.common.util.NeedleEye;
import com.capestartproject.common.util.data.Effect0;
...
public abstract class AbstractWorkflowCleanupScheduler {
	...
	private static final String JOB_NAME = "ch-workflow-cleanup-job";
	private static final String JOB_GROUP = "ch-workflow-cleanup-job-group";
	private static final String TRIGGER_NAME = "ch-workflow-cleanup-trigger";
	private static final String TRIGGER_GROUP = "ch-workflow-cleanup-trigger-group";
