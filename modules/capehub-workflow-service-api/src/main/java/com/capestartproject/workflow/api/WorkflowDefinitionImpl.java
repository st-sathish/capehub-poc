 ...
 */
@XmlType(name = "definition", namespace = "http://workflow.capestartproject.com")
@XmlRootElement(name = "definition", namespace = "http://workflow.capestartproject.com")
...
public class WorkflowDefinitionImpl implements WorkflowDefinition {
  ...
  private List<WorkflowOperationDefinition> operations;
	 ...
	 * {@inheritDoc}
	 *
	 * @see com.capestartproject.workflow.api.WorkflowDefinition#getId()
	 */
  public String getId() {
    return id;
  }
	 ...
	 * {@inheritDoc}
	 *
	 * @see com.capestartproject.workflow.api.WorkflowDefinition#setId(java.lang.String)
	 */
  public void setId(String id) {
	 ...
	 * {@inheritDoc}
	 *
	 * @see com.capestartproject.workflow.api.WorkflowDefinition#getDescription()
	 */
  public String getDescription() {
	 ...
	 * {@inheritDoc}
	 *
	 * @see com.capestartproject.workflow.api.WorkflowDefinition#setDescription(java.lang.String)
	 */
  ...
  public void setConfigurationPanel(String panelXML) {
	 ...
	 * {@inheritDoc}
	 *
	 * @see com.capestartproject.workflow.api.WorkflowDefinition#getConfigurationPanel()
	 */
  public String getConfigurationPanel() {
	 ...
	 * {@inheritDoc}
	 *
	 * @see com.capestartproject.workflow.api.WorkflowDefinition#getOperations()
	 */
  public List<WorkflowOperationDefinition> getOperations() {
	 ...
	 * {@inheritDoc}
	 *
	 * @see com.capestartproject.workflow.api.WorkflowDefinition#get(int)
	 */
  @Override
  public WorkflowOperationDefinition get(int position) throws IndexOutOfBoundsException {
	 ...
	 * {@inheritDoc}
	 *
	 * @see com.capestartproject.workflow.api.WorkflowDefinition#add(org.opencastproject.workflow.api.WorkflowOperationDefinition)
	 */
  @Override
  ...
  public void add(WorkflowOperationDefinition operation, int position) {
	 ...
	 * {@inheritDoc}
	 *
	 * @see com.capestartproject.workflow.api.WorkflowDefinition#remove(int)
	 */
  @Override
  public WorkflowOperationDefinition remove(int position) throws IndexOutOfBoundsException {
    ...
    return operations.remove(position);
  	...
  	/**
	 * @see com.capestartproject.workflow.api.WorkflowDefinition#addTag(String)
	 */
  @Override
  public void addTag(String tag) {
    ...
    tags.add(tag);
  	...
  	/**
	 * @see com.capestartproject.workflow.api.WorkflowDefinition#removeTag(String)
	 */
  @Override
  public void removeTag(String tag) {
    ...
    tags.remove(tag);
  	...
  	/**
	 * @see com.capestartproject.workflow.api.WorkflowDefinition#containsTag(String)
	 */
  @Override
  public boolean containsTag(String tag) {
    ...
    return tags.contains(tag);
  	...
  	/**
	 * @see com.capestartproject.workflow.api.WorkflowDefinition#containsTag(Collection)
	 */
  @Override
  public boolean containsTag(Collection<String> tags) {
    ...
    return false;
  	...
  	/**
	 * @see com.capestartproject.workflow.api.WorkflowDefinition#getTags()
	 */
  @Override
  public String[] getTags() {
    return tags.toArray(new String[tags.size()]);
  	...
  	/**
	 * @see com.capestartproject.workflow.api.WorkflowDefinition#clearTags()
	 */
  @Override
