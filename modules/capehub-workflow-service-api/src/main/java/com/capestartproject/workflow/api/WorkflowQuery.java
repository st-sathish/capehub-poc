...
public class WorkflowQuery {
  ...
  protected String seriesId;
	protected String employeePackageId;
   ...
   */
	public WorkflowQuery withMediaPackage(String employeePackageId) {
		if (StringUtils.isNotBlank(employeePackageId))
  ...
  public String getSeriesTitle() {
    return seriesTitle;
  	...
  	/**
	 * Returns the employee package identifier that workflow instances need to
	 * match.
	 *
	 * @return the employee package identifier
	 */
	public String getEmployeePackageId() {
