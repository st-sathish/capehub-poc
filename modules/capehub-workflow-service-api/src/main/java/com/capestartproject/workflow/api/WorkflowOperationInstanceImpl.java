 ...
 */
@XmlType(name = "operation-instance", namespace = "http://workflow.capestartproject.com")
@XmlRootElement(name = "operation-instance", namespace = "http://workflow.capestartproject.com")
