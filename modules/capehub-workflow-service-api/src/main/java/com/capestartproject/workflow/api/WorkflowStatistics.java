...
@XmlRootElement(name = "statistics", namespace = "http://workflow.capestartproject.com")
@XmlType(name = "statistics", namespace = "http://workflow.capestartproject.com")
public class WorkflowStatistics {
   ...
   */
  @XmlAccessorType(XmlAccessType.FIELD)
	@XmlRootElement(name = "definition_report", namespace = "http://workflow.capestartproject.com")
	@XmlType(name = "definition_report", namespace = "http://workflow.capestartproject.com")
  public static class WorkflowDefinitionReport {
     ...
     */
    @XmlAccessorType(XmlAccessType.FIELD)
		@XmlRootElement(name = "operation_report", namespace = "http://workflow.capestartproject.com")
		@XmlType(name = "operation_report", namespace = "http://workflow.capestartproject.com")
