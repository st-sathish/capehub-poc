...
import static com.capestartproject.common.util.IoSupport.withFile;
import static com.capestartproject.common.util.RestUtil.fileResponse;
import static com.capestartproject.common.util.RestUtil.partialFileResponse;
import static com.capestartproject.common.util.RestUtil.streamResponse;
...
import static com.capestartproject.common.util.doc.rest.RestParameter.Type.FILE;
...
public class WorkingFileRepositoryRestEndpoint extends WorkingFileRepositoryImpl {
  ...
  @Produces(MediaType.TEXT_HTML)
	@Path(WorkingFileRepository.EMPLOYEEPACKAGE_PATH_PREFIX + "{mediaPackageID}/{mediaPackageElementID}")
  ...
  @POST
  @Produces(MediaType.TEXT_HTML)
	@Path(WorkingFileRepository.EMPLOYEEPACKAGE_PATH_PREFIX + "{mediaPackageID}/{mediaPackageElementID}/{filename}")
